...
from spline_registration.utils import create_results_dir,rescalar_imatge, color_a_grisos,ampliacio_malla
...
def main():
    ...
    for i in [1,1998,2020]:
        ...
        corregistre1 = ElasticTransform_SSD(mida_malla1, dim_imatge)
        ...
        path_carpeta_experiment = create_results_dir(f'{i} ')
        ...
        millor_malla_preliminar1 = corregistre1.guardar_millor_imatge_registrada( input, reference, malla_vector1,
                                                     path_carpeta_experiment,fitxer_sortida,100)
        ...
        corregistre2 = ElasticTransform_SSD(mida_malla2, dim_imatge2)
        ...
        corregistre4 = ElasticTransform_SSD(mida_malla3,dim_original)
        ...
        pixels entre dos punts consecutius de la malla:{pixels_per_vertex}, factor perturbacio {1/5}\n
        ...
        residus:residus imatges ,{0.1}*residuals_regularizacio
